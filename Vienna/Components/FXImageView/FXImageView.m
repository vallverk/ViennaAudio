...
- (void)setUp
{
    ...
    [act setAutoresizingMask:UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleWidth];
...
-(void)hideIndicator
{
    if (self.originalImage!=nil||self.processedImage!=nil||self.image!=nil) {
        [act stopAnimating];
       // [timer invalidate];
       // timer = nil;
    }
